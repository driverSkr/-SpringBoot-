<template>
  <div>
    ...
    <div style="margin: 10px 0">
      ...
      <el-input style="width: 200px" placeholder="请输入学号" suffix-icon="el-icon-message" class="ml-5" v-model="id"></el-input>
      <el-input style="width: 200px" placeholder="请输入班级" suffix-icon="el-icon-position" class="ml-5" v-model="className"></el-input>
...
export default {
  ...
  methods: {
    ...
    //“确认”提交表单
    save(){
      request.post("/admin/insert",this.form).then(res => {
        if (res.data){
    ...
    delBatch(){
      ...
      request.delete("/admin/delete/batch", {data:ids}).then(res => {
        if (res.data){
